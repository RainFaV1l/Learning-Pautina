<div class="auth-modal modal guest-course-subscribe-modal">
    <div class="auth-modal__container modal__container">
        <a class="auth-modal__close modal__close">
        ...
        <div class="auth-modal__content modal__content">
            <div class="auth-modal__header modal__header">
                <h2 class="auth-modal__title modal__title">Авторизуйтесь</h2>
                <p class="auth-modal__subtitle modal__subtitle">Для записи на курс необходимо войти в аккаунт</p>
            </div>
            <a href="{{ '/login' }}" class="auth-modal__button modal__button">Войти</a>
        </div>
    </div>
</div>
