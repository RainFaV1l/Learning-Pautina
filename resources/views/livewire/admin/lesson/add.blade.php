                                ...
                                <div class="add-course__form add-course-form">
                                    <form action="{{ route('lessons.store') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form__item">
                                            <div class="error__input-column">
                                                <div class="input-column @error('name') error @enderror">
                                                    <input value="{{ old('name') }}" type="text" name="name" class="input add-course-form__input"
                                                           required autofocus>
                                        ...
                                        <div class="form__item">
                                            <div class="error__input-column">
                                                <div class="input-column @error('name') error @enderror">
                                                    <input value="{{ old('lesson_number') }}" type="text" name="lesson_number" class="input add-course-form__input"
                                                           required autofocus>
                                        ...
                                        <div class="add-course-form__img add-course-form-img dragable-img-multi">
                                            <input id="dragImg" type="file" name="file_path[]" multiple
                                        ...
                                        <div class="add-video-column video__inputs">
                                            ...
                                            <div class="video__input-column">
                                                <input type="text" name="inputs[0][video_path]" class="add-course-form__input"
